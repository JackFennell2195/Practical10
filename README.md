...
* Lab 10 Experiment with a Cube, Vertex and Fragment Shaders
...
* Clone the project `git clone https://MuddyGames@bitbucket.org/MuddyGames/gameplay-programming-i-lab-10.git`

* Change to the project directory `cd projects gameplay-programming-i-lab-10`
